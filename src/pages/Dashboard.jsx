...
const ALL_PAGES = [
  ...
  { id: 'community-hub', label: 'Community Hub', route: '/community-hub', image: MEDIA + 'adea60992_generated_image.png', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', keywords: ['community', 'groups'] },
