...
const ALL_PAGES = [
  ...
  { id: 'glow-feed', label: 'Glow Feed', route: '/glow-feed', image: MEDIA + '6df1ddfdd_generated_image.png', gradient: 'from-yellow-800 via-amber-900 to-pink-900', keywords: ['feed', 'posts', 'community', 'social'] },
  ...
  { id: 'community-hub', label: 'Community Hub', route: '/community-hub', image: MEDIA + 'f3d41f651_generated_image.png', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', keywords: ['community', 'groups'] },
  { id: 'mentorship', label: 'Mentorship', route: '/mentorship', image: MEDIA + '51e16eabf_generated_image.png', gradient: 'from-purple-900 via-pink-900 to-rose-900', keywords: ['mentor', 'guidance', 'coach'] },
