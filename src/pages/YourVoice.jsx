...
const CIVIC_TOPICS = [
  ...
  },
  {
    ...
    key_facts: ['Preventive care is covered at no cost under most health insurance plans.', 'Many serious health conditions have no symptoms in early stages, which is why routine screenings matter.', 'Mental health checkups are just as important as physical ones.', 'You have the right to ask questions, request a second opinion, and understand everything happening with your body.'],
    sections: [
      ...
      { title: 'Mental Health Check-Ins', content: 'Mental health is health. If you\'re feeling persistently sad, anxious, overwhelmed, or disconnected, talk to your primary care provider or a mental health professional. Therapy is not just for crisis situations.' },
    ...
    activities: ['Create a personal health calendar for the next 12 months. Schedule your annual wellness visit, dental cleaning, and eye exam.', 'Ask a parent or trusted family member about your family\'s health history. Write down what you learn.', 'If you don\'t have health insurance, research one free or low-cost health resource in your area.'],
    quiz: [
      { q: 'When is the first gynecology visit recommended?', options: ['At age 21, when Pap smears begin','Between ages 13–15, or when you become sexually active, whichever comes first','Only when you have a problem','At age 18'], answer: 1, explanation: 'The first gynecology visit is recommended between ages 13–15, or when you become sexually active. The first visit is usually just a conversation — no exam is required unless there\'s a specific concern.' },
      { q: 'How often should most people get a dental cleaning?', options: ['Once a year','Every 6 months','Every 2 years','Only when you have a toothache'], answer: 1, explanation: 'Dental cleanings every 6 months are standard. Regular cleanings prevent cavities and gum disease, and dentists can detect signs of other health conditions.' },
      { q: 'What should you do if you don\'t have health insurance?', options: ['Skip healthcare until you can afford it','Only go to the emergency room','Look into FQHCs, Planned Parenthood, Medicaid, or community health fairs','Ask a friend to share their prescription medications'], answer: 2, explanation: 'Many free and low-cost healthcare resources exist. FQHCs, Planned Parenthood, Medicaid, and community health clinics all provide care regardless of insurance status.' },
    ],
    call_to_action: 'Schedule one health appointment this week — your annual wellness visit, a dental cleaning, or an eye exam. Put it in your calendar right now.',
  },
  {
    ...
    sections: [
      ...
      { title: 'Why We Obsess Over the Future', content: 'Our brains are wired to plan ahead. But in modern life, that same wiring can turn into constant "what if" thinking. Social media makes it worse because you see everyone else\'s highlight reel. You are not behind. You are on your own timeline.' },
      ...
      { title: 'Signs You\'re Not Trusting the Process', content: 'You compare yourself to others constantly. You feel like you\'re always "behind." You quit things early because results aren\'t coming fast enough. If any of these sound familiar, that\'s okay — awareness is the first step. The goal isn\'t perfection; it\'s progress.' },
      { title: 'How to Actually Trust the Process', content: 'Define YOUR process — what daily habits move you toward your goal? Track your inputs, not just your outputs. Did you study? Did you practice? Did you show up? That counts. Celebrate small wins.' },
      { title: 'Real Talk: What Happens When You Don\'t Trust the Process', content: 'You quit too early. You switch goals every few weeks and never build real momentum. The girls who "made it" — in sports, business, art, academics — almost all have the same story: they kept going when it was hard and when results were invisible.' },
    ],
    ...
    quiz: [
      { q: 'What is the main difference between planning and worrying?', options: ['Planning is for smart people; worrying is for everyone else','Planning leads to action; worrying replays scenarios you can\'t control','Planning takes longer than worrying','There is no difference'], answer: 1, explanation: 'Planning is productive — it leads to action. Worrying is unproductive — it exhausts you without moving you forward.' },
      { q: 'Which of these is a sign that you are NOT trusting the process?', options: ['Celebrating small wins','Tracking your daily habits','Quitting things early because results aren\'t coming fast enough','Finding a mentor'], answer: 2, explanation: 'Quitting early because results aren\'t visible yet is a classic sign of not trusting the process. Real growth often happens before you can see it.' },
      { q: 'When you can\'t control an outcome, the best thing to do is:', options: ['Worry about it constantly so you\'re prepared','Ignore it completely','Release it and refocus your energy on what you can control','Ask everyone around you what they think will happen'], answer: 2, explanation: 'You can only control your effort, attitude, and actions. Releasing what you can\'t control and refocusing on what you can is the foundation of trusting the process.' },
    ],
    call_to_action: 'Write down your process — 3 daily habits that move you toward your biggest goal. Commit to them for 7 days without checking for results. Just trust.',
  },
  {
    id: 'manipulation',
    stages: ['glow_teens','glow_women'],
  ...
  },
  {
    ...
    sections: [
      ...
      { title: 'Study Habits That Actually Work', content: 'Active recall: close your notes and try to recall what you learned. Spaced repetition: study material over multiple sessions spread out over days. The Pomodoro Technique: study for 25 minutes, take a 5-minute break. Teach it: if you can explain a concept to someone else in simple terms, you truly understand it.' },
      { title: 'How to Handle Hard Classes and Failing Grades', content: 'Don\'t panic and don\'t give up. A bad grade is information, not a verdict on your intelligence. Talk to your teacher, go to tutoring, or form a study group. One bad grade does not define your future — your response to it does.' },
      { title: 'Organization and Time Management', content: 'Use a planner or digital calendar to track assignments, tests, and deadlines. Break big projects into smaller tasks with their own mini-deadlines. Don\'t wait until the night before.' },
      { title: 'Building Relationships with Teachers', content: 'Your teachers are one of your most underused resources. Introduce yourself. Participate in class. Ask questions. Go to office hours. These relationships can lead to recommendation letters, mentorship, and opportunities you would never find on your own.' },
    ],
    activities: ['Create a weekly study schedule. Use the Pomodoro Technique for at least one session this week and note how it affects your focus.', 'Look at your current grades. Pick one class where you could improve. Write down 3 specific actions you will take this week.', 'This week, speak to one teacher outside of class time — ask a question, thank them for something, or ask for advice.'],
    quiz: [
      { q: 'What is "active recall" in studying?', options: ['Re-reading your notes multiple times','Highlighting everything in your textbook','Closing your notes and trying to remember what you learned','Studying with music playing'], answer: 2, explanation: 'Active recall means closing your notes and testing yourself on what you remember. This is one of the most effective study techniques because it strengthens memory retrieval.' },
      { q: 'How long does it take on average to fully refocus after checking your phone during studying?', options: ['2 minutes','5 minutes','23 minutes','1 hour'], answer: 2, explanation: 'Research shows it takes an average of 23 minutes to fully regain focus after a distraction. This is why putting your phone away during study sessions is so important.' },
      { q: 'What is the best response to a failing grade?', options: ['Give up on the class','Hide it from your parents','Analyze what went wrong, ask for help, and take specific action to improve','Blame the teacher'], answer: 2, explanation: 'A failing grade is information, not a verdict. The best response is to understand what went wrong, seek help, and take specific action. Your response to setbacks defines your trajectory.' },
    ],
    call_to_action: 'Pick one study habit from this resource and commit to using it every day for the next 2 weeks. Track your results in your journal.',
  },
  {
    id: 'good_employee',
    stages: ['glow_teens','glow_women'],
