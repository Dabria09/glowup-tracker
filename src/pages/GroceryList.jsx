    ...
    <div className="min-h-screen text-white pb-24 relative overflow-y-auto" style={{ backgroundColor: '#080810' }}>
      ...
      {showAdd && (
        <div className="fixed inset-0 bg-black/60 z-50 flex items-end" onClick={() => { setShowAdd(false); setShowCatPicker(false); }}>
          <div className="w-full rounded-t-3xl p-6 pb-10" style={{ background: '#1a0a2e', border: '1px solid rgba(255,255,255,0.1)' }} onClick={e => e.stopPropagation()}>
            ...
            <div className="flex gap-3 mb-5">
              ...
              <div className="flex-1 relative">
                ...
                {showCatPicker && (
                  <div className="absolute bottom-full left-0 right-0 mb-2 rounded-2xl overflow-hidden shadow-2xl z-10"
