...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'money_moves', label: 'Money Moves', gradient: 'from-green-900 via-emerald-900 to-teal-900', route: '/money-tracker', image: CDN + 'icon-money-tracker-2TYacsiWgAXqNkGsYeqxTn.webp' },
