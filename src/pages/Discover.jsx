...
const SECTIONS = [
  {
    ...
    title: '📚 Learn & Grow',
    items: [
      { id: 'ggu_academy', label: 'GGU Academy', emoji: '🏛️', gradient: 'from-pink-900 via-purple-900 to-pink-800', route: '/ggu-academy', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/261590eda_IMG_4336.png' },
      { id: 'girls_library', label: 'Girls Library', emoji: '📚', gradient: 'from-amber-800 via-orange-900 to-yellow-900', route: '/girls-library', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/fdac3d1ec_IMG_4337.png' },
      { id: 'career_explorer', label: 'Career Explorer', emoji: '💼', gradient: 'from-yellow-800 via-amber-900 to-orange-900', route: '/career-explorer', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/25545d9b8_IMG_4338.png' },
      { id: 'your_voice', label: 'Your Voice', emoji: '🗳️', gradient: 'from-rose-900 via-red-900 to-pink-900', route: '/your-voice', badge: 'New', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/8e41654a9_IMG_4339.png' },
      { id: 'growth_mindset', label: 'Growth Mindset', emoji: '🧠', gradient: 'from-purple-900 via-fuchsia-900 to-pink-900', route: '/growth-mindset', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/3b3deb67b_IMG_4340.png' },
      { id: 'homework_tracker', label: 'Homework Tracker', emoji: '📓', gradient: 'from-gray-800 via-slate-900 to-gray-900', route: '/homework-tracker', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/d01d448e8_IMG_4341.png' },
      { id: 'daily_quotes', label: 'Daily Quotes', emoji: '✨', gradient: 'from-yellow-800 via-amber-900 to-orange-900', route: '/daily-quotes', image: 'https://media.base44.com/images/public/6a0e12a89992f9565c11e330/08f17f516_IMG_4342.png' },
