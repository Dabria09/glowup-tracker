...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'glow_checkin', label: 'Glow Check-In', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', route: '/glow-checkin', image: MANUS + 'icon-glow-check-in_fe36a2ac.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'vision_board', label: 'Vision Board', gradient: 'from-pink-900 via-rose-900 to-orange-900', route: '/vision-board', image: MANUS + 'icon-sparkles-magic_5e5bed27.png' },
