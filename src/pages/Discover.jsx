...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { id: 'community_hub', label: 'Community Hub', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', route: '/community-hub', image: G + 'f3d41f651_generated_image.png' },
      { id: 'glow_feed', label: 'Glow Feed', gradient: 'from-yellow-800 via-amber-900 to-pink-900', route: '/glow-feed', image: G + '6df1ddfdd_generated_image.png' },
      { id: 'mentorship', label: 'Mentorship', gradient: 'from-purple-900 via-pink-900 to-rose-900', route: '/mentorship', image: G + '51e16eabf_generated_image.png' },
