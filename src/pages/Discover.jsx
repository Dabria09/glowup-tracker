...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'weekly_challenges', label: 'Weekly Challenges', gradient: 'from-pink-900 via-rose-900 to-red-900', route: '/weekly-challenges', image: CDN + 'icon-daily-challenges-5aR9HwiMcVmjJVeR6dG8u8.webp' },
