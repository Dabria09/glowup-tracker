...
const SECTIONS = [
  ...
  },
  {
    ...
    title: '💰 Money & Future',
    items: [
      { id: 'money_savings', label: 'Money & Savings', gradient: 'from-yellow-800 via-amber-900 to-yellow-900', route: '/money-tracker', image: CDN + 'icon-money-tracker-2TYacsiWgAXqNkGsYeqxTn.webp' },
