...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'career_explorer', label: 'Career Explorer', gradient: 'from-yellow-800 via-amber-900 to-orange-900', route: '/careers', image: G + '86a946cf1_generated_image.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'cycle_tracker', label: 'Cycle Tracker', gradient: 'from-purple-900 via-fuchsia-900 to-pink-900', route: '/cycle-tracker', image: G + 'f4bdde233_generated_image.png' },
      ...
      { id: 'spiritual_glow', label: 'Spiritual Glow', gradient: 'from-indigo-900 via-purple-900 to-violet-900', route: '/spiritual-glow', image: G + '063e7b1a4_generated_image.png' },
    ],
  },
  {
    id: 'money',
    title: '💰 Money & Future',
    items: [
      { id: 'money_savings', label: 'Money & Savings', gradient: 'from-yellow-800 via-amber-900 to-yellow-900', route: '/money-tracker', image: G + '672bb0300_generated_image.png' },
      ...
      { id: 'vision_board', label: 'Vision Board', gradient: 'from-pink-900 via-rose-900 to-orange-900', route: '/vision-board', image: G + '54490e5d7_generated_image.png' },
      { id: 'scholarships', label: 'Scholarships', gradient: 'from-amber-900 via-yellow-900 to-orange-900', route: '/scholarships', image: G + 'c3a65cd04_generated_image.png' },
  ...
  },
  {
    ...
    items: [
      { id: 'community_hub', label: 'Community Hub', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', route: '/community-hub', image: G + 'e547cd62b_generated_image.png' },
      ...
      { id: 'mentorship', label: 'Mentorship', gradient: 'from-purple-900 via-pink-900 to-rose-900', route: '/mentorship', image: G + '1555c00a3_generated_image.png' },
      ...
      { id: 'glow_board', label: 'Glow Board', gradient: 'from-pink-900 via-rose-900 to-fuchsia-900', route: '/glow-board', image: G + 'a76e19c27_generated_image.png', badge: 'New' },
      { id: 'glow_kitchen', label: 'Glow Kitchen', gradient: 'from-rose-900 via-pink-900 to-fuchsia-900', route: '/glow-kitchen', image: G + 'ad580c299_generated_image.png' },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'sticky_notes', label: 'Sticky Notes', gradient: 'from-violet-900 via-purple-900 to-fuchsia-900', route: '/sticky-notes', image: G + '4ae648cef_generated_image.png' },
      ...
      { id: 'cycle_tracker_life', label: 'Cycle Tracker', gradient: 'from-purple-900 via-fuchsia-900 to-pink-900', route: '/cycle-tracker', image: G + 'f4bdde233_generated_image.png' },
      { id: 'spiritual_glow_life', label: 'Spiritual Glow', gradient: 'from-indigo-900 via-purple-900 to-violet-900', route: '/spiritual-glow', image: G + '063e7b1a4_generated_image.png' },
      ...
      { id: 'vision_board_life', label: 'Vision Board', gradient: 'from-pink-900 via-rose-900 to-orange-900', route: '/vision-board', image: G + '54490e5d7_generated_image.png' },
