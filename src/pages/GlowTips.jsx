...
const TIPS_BY_AGE = {
  ...
  adult_entrepreneur: {
    confidence: [
      'Your voice in the boardroom is just as valuable as anyone else\'s',
      'Negotiate your salary — women who negotiate earn $1M more over their careers',
      'Stop over-explaining yourself in professional settings',
      'Confidence is built by doing hard things repeatedly',
      'You are the CEO of your own life — lead accordingly',
    ],
    money: [
      'Automate your savings so you pay yourself first, every month',
      'Invest in index funds — time in the market beats timing the market',
      'Build 6 months of emergency fund before investing aggressively',
      'Your business idea needs a financial plan, not just a passion',
      'Tax-advantaged accounts (401k, IRA, HSA) are free money — max them out',
    ],
    school: [
      'Never stop learning — read one book per month in your field',
      'Certifications and courses can pivot your career in 6 months',
      'Teach what you know — it deepens your own understanding',
      'Mentorship is a two-way street — find one and be one',
      'Your education doesn\'t end with a degree — it just begins',
    ],
    relationships: [
      'Healthy partnerships are built on shared values, not just attraction',
      'Financial transparency with your partner prevents 80% of relationship conflicts',
      'You can love someone and still need space — boundaries are love',
      'Surround yourself with people who are where you want to be',
      'Your inner circle determines your outer results',
    ],
    wellness: [
      'Stress management is a business skill — invest in it',
      'Sleep is your highest-ROI productivity tool',
      'Annual checkups are cheaper than emergency care — schedule yours',
      'Burnout is real — rest is not a reward, it\'s a requirement',
      'Your body is your most important business asset — protect it',
    ],
    mindset: [
      'Failure is the tuition you pay for success — get your money\'s worth',
      'Done is better than perfect — ship it and iterate',
      'Your past does not equal your future unless you live there',
      'The most successful people have the most failures — keep going',
      'Gratitude is the highest-frequency emotion — practice it daily',
    ],
    career: [
      'Update your resume quarterly — opportunities come when you least expect them',
      'Build in public — share your journey and attract your tribe',
      'Passive income is the goal — build systems, not just skills',
      'Your personal brand is your most valuable business asset',
      'Charge what you\'re worth — underpricing is a confidence problem',
    ],
  },
};
